...
class NullLayoutTestPanel extends Panel {
	...
	public void addNotify() {
		...
		ps = choice.getPreferredSize();
		choice.setBounds(10,35,ps.width,ps.height);

		ps = label.getPreferredSize();
		label.setBounds(230,120,ps.width,ps.height);

		ps = checkbox.getPreferredSize();
		checkbox.setBounds(120,120,ps.width,ps.height);

		ps = textfield.getPreferredSize();
		textfield.setBounds(120,10,ps.width,ps.height);

		ps = scrollbar.getPreferredSize();
		scrollbar.setBounds(120,160,ps.width,ps.height);

		ps = button.getPreferredSize();
		button.setBounds(375,10,ps.width,ps.height);

		ps = list.getPreferredSize();
		list.setBounds(230,10,ps.width,ps.height);
	}
