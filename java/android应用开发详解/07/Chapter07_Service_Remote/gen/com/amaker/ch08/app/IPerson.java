 ...
 * Original file: D:\\我的文档\\桌面\\Android图书(2009-12-3)\\Android图书\\code\\07\\Chapter07_Service_Remote\\src\\com\\amaker\\ch08\\app\\IPerson.aidl
 */
...
public static abstract class Stub extends android.os.Binder implements com.amaker.ch08.app.IPerson
{
...
/**
 * Cast an IBinder object into an IPerson interface,
 * generating a proxy if needed.
 */
public static com.amaker.ch08.app.IPerson asInterface(android.os.IBinder obj)
{
if ((obj==null)) {
return null;
}
...
return ((com.amaker.ch08.app.IPerson)iin);
}
return new com.amaker.ch08.app.IPerson.Stub.Proxy(obj);
}
...
private static class Proxy implements com.amaker.ch08.app.IPerson
{
