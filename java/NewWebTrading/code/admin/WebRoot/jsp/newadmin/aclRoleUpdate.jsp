...
<form action="updateAclRole.do?method=updateAclRole" name="aclRoleForm"  method="post" onsubmit="return checkSubmit();">
<table align="left">
 	<tr bgcolor="#A5B7C5">
	 <td colspan="2" align="center" > <STRONG>Update Acl Role</STRONG></td>
	 </tr> 
	<tr>
		<td width="15%">Role ID </td>
		<td><html:text property="roleId" name="aclRoleForm" readonly="true"></html:text></td>
	</tr>
	<tr>
...
<div id="menuId" align="right"><%@ include file="./menuSelect.jsp"%></div>
</form>
</body>