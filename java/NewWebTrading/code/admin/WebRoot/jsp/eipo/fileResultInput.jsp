...
<html>
<head>
<title>Uploade IPO Result data</title>
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
</head>
<link href="../jsp/css/link.css" rel="stylesheet" type="text/css">
<%@ include file="../js/checkurl.jsp"%>
<body bgcolor="E8EDF1"> 
<form name="form1" method="post" action="fileResultUpload.jsp" enctype="multipart/form-data" onsubmit="return CheckForm(this)">
  <p>&nbsp;</p>
              ...
              <table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="4a5293">
                <tr bgcolor="#FFFFFF"> 
                  <td colspan="3"  bgcolor="#A5B7C5"><b><font color="#000066">Import 
                    eIPO Result INFo </font></b></td>
                </tr>
                <tr bgcolor="#FFFFFF"> 
                  <td colspan="3"><font color="#FF0000">Notice:1>The File include eIPO Result Info.</font></td>
                </tr>
                <tr bgcolor="#FFFFFF"> 
                  <td height="16" colspan="3"><font color="#FF0000">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
                    2>The eIPO Result Info file name must as "IPOOrderRequestResult_[RefIPOCode].dat".</font></td>
                </tr>
                <tr bgcolor="#FFFFFF"> 
                ...
                <tr bgcolor="#999999"> 
				  ...
				  Result Info File:<input name="file2" type="file" size="50" ContentEditable="false"> </td>
                </tr>
                <tr align="right" valign="middle" bgcolor="#FFFFFF"> 
...
<!--
	function CheckForm(theForm)
	{
		...
		lastName = fileName2.substr(0,22);
		if(lastName!="IPOOrderRequestResult_")
		{
			alert("the eIPO Result Info data file is wrong,please select again!");
		    theForm.file2.focus();
			return false;
		}
	}
