...
public interface Facade {
	...
	//3.3.2	Services Product Maintenance
	...
	//3.3.3	User Product Renewal
	//3.3.3.1--3.3.3.2	User Product Renewal
	public ExecuteAutoEnrollmentResponseModel exeAutoEnrollment(String  actionBy);
	//3.3.3.3	Memo-debit
...
//	public ReserveAndRenewalEnquiryResponseModel reserveAndRenewalEnquiry(ReserveAndRenewalEnquiryRequestModel reserveAndRenewalEnquiryRequestModel);
	...
	//3.3.5.1.1	Initial RTQ App 用sql脚本创建  	
	...
	//3.3.7	System Administration (杨明实现)
	...
	//3.3.8	System Configuration 待实现
