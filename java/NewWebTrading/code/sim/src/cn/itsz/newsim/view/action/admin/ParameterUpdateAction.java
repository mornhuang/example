...
@Controller("/nadmin/paramUpdate")
public class ParameterUpdateAction extends BaseAction {
	...
	public static void form2Model(HttpServletRequest request,
		...
		destModel.setPvalue(model.getPvalue());
		destModel.setPdesc(model.getPdesc());
	}
}
