...
import com.itsz.sht.struts.eipo.form.EIPOMasterDetailForm;
import com.itsz.sht.vp.ViewProvider;
import com.itsz.sht.vp.common.ProcessBean;
import com.taifook.mcs.core.beans.msg.TradingAccountInfo;
public class EIPOMasterDetailAction extends ITSZAction{

	public ActionForward executeAction(ViewProvider vp, ActionMapping mapping,
            ActionForm form, HttpServletRequest request,
            HttpServletResponse response) {
		EIPOMasterDetailRequestModel model = new EIPOMasterDetailRequestModel();
		DataModelUtil.form2Model(request,(EIPOMasterDetailForm) form, model, response);
		...
		model.setMr(mr);
		EIPOMasterDetailResponseModel responseModel = facade.getEIPOMasterDetail(model);
		ProcessBean processBean = new ProcessBean(responseModel,null, mapping, request,response);
		return vp.processEIPOMasterDetail(processBean);
	}
