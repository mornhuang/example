...
import com.itsz.sht.struts.form.CalMosActionForm;
...
/**
 * 
 * $Id: CallMosPSAction.java,v 1.1 2011/03/09 06:45:18 pbxie Exp $
 * 
 * @Project:portal
 ...
 * @Date:2008-3-19
 */
public class CallMosPSAction extends ITSZAction {
	...
	private MosRequestModel fillRequestValue(HttpServletRequest request,
		...
		DataModelUtil.form2Model(request, (CalMosActionForm) form, model, response);
