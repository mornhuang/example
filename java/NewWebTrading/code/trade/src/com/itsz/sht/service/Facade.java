...
public interface Facade {
	...
	public PrePlaceOrderResponseModel prePlaceOrder(PrePlaceOrderRequestModel orderModel);
	
	public PlaceOrderResponseModel placeOrder(PlaceOrderRequestModel orderModel);
	
	public FilterOrderResponseModel filterOrder(FilterOrderRequestModel filterModel);
	...
	//ADD by Arthur xli on 20110504 for eipo
