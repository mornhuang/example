...
/**
 * $Id: EnquireRTQResponse.java,v 1.1 2010/11/09 03:57:28 kyzou Exp $
 * @Project:portal
 * @File:EnquireRTQResponse.java
 * @Description:
 * @Author:kyzou
 * @Date:2008-3-19
 */
public class EnquireRTQResponse {
    private String Code;
    private String Name;
    private String Time;
    ...
    private String canBidBPrice;
    private String canAskBPrice;
    
	public String getCanBidBPrice() {
		return canBidBPrice;
	}

	public void setCanBidBPrice(String canBidBPrice) {
		this.canBidBPrice = canBidBPrice;
	}

	public String getCanAskBPrice() {
		return canAskBPrice;
	}

	public void setCanAskBPrice(String canAskBPrice) {
		this.canAskBPrice = canAskBPrice;
	}
