...
public class Constants {
	...
	/**
	 * @deprecated
	 * @see com.itsz.channelsserver.common.Consts.Mobile.LocaleHelper#DEFAULT_LOCALE_VALUE
	 */
	public static final Locale defaultLocale = Locale.TRADITIONAL_CHINESE;

	public static final String REQUEST_TOKEN_KEY = org.apache.struts.taglib.html.Constants.TOKEN_KEY;
	...
	public final static String ERRORCODE_PARAMETER_EMESSAGE = "EM001";
	...
	public static final String ERRORCODE_ESRV_SALE_CATALOG_SUBSCRIBED = "ESRV_SALE_CATALOG_SUBSCRIBED";

	public static final String ERRORCODE_ESRV_PRD_INSUFFICIENT_PRD = "ESRV_PRD_INSUFFICIENT_PRD";
	...
	/**
	 * @deprecated
	 * @see com.itsz.channelsserver.common.Consts.RTQ#SIMPLE_RTQ_DELAY_TIME
	 */
	public final static String SIMPLE_RTQ_DELAY_TIME = "SimpleRtqDelayTime";
	
	public final static String FORMATINSTRCODE = "FORMATINSTRCODE";
	...
	public static final String MsgID_MOrderFilter = "MROFT";
	
	public static final String MsgID_MCalOrderFee = "MRCOF";
	...
	public static final String MsgID_MLogin = "MRLOI";
	
	public static final String MsgID_MECertLogin = "MRELI";
	
	public static final String MsgID_MAcSummary = "MQASU";
	
	public static final String MsgID_MCashDetail = "MQACC";
	...
	public static final String PROVIDER_AASTOCK = "SSTR_AAST";

	public static final String PROVIDER_HKSTOCK = "hkstock";

	public static final String PROVIDER_TAIFOOK = "taifook";

	public static final String PROVIDER_QUOTEPOWER = "quotepower";
	...
	public static final String PROVIDER_ETNET = "SSTR_IQS";
	...
	public static final String PORTAL_3G = "portal3g";

	public static final String USASTOCKCODE = "USAStockCode";

	public static final String RTQ_COMMON_TIME = "RTQ_COMMON_TIME";

	public static final String RTQ_NON_MONTHSERVICE = "0";

	public static final String RTQ_MONTHSERVICE = "1";

	public static final String IMAGE_TYPE = "candle";

	public static final String IMAGE_INTERVAL = "360";

	public static final String PRODUCT_DTO = "product_dto";

	public static final String PAYMENT_TAIFOOK_POINT = "TF_POINT";

	public static final String PAYMENT_TAIFOOK_ACCOUNT = "TF_ACCOUNT";

	public static final String VIEW_QUOTORECORD = "qutorecord";

	public static final String AFXNEWS_CONST = "5";

	public static final String RTQ_3G = "RTQ_3G";

	public static final String ESRV_WATCHLIST_DELFAIL = "delWatchListFail";

	public static final String ESRV_WATCHLIST_ADDFAIL = "AddWatchListFail";

	public static final String HSI_CONST = ".HSI";

	public static final String HSCE_CONST = "HSIc1";

	public static final String MARKET_DEPTH = "marketDepth";

	public static final String MCS_QACE_ERROR = "QACEERROR";

	public static final int MAX_RECORD_SIZE = 60;
	/**
	 * @deprecated
	 * @see com.itsz.channelsserver.common.Consts.Qs#DELAY_TIME
	 */
	public static final String RTQ_DELAY_TIME ="15";

	public static final String LANG_GBK = "GBK";
	...
	private static final String fullClassName = Constants.class.getClass().getName();
	...
	public static final String TF_POINT = "TF_POINT";

	public static final String TF_ACCOUNT = "TF_ACCOUNT";

	public static final String EMESSAGE_KEY_URL ="EMESSAGE_KEY_URL";
	
	public static final String EMESSAGE_CONTENT_URL ="EMESSAGE_CONTENT_URL";
	
	public static final String EMESSAGE_CHARACTER_ENCODE ="UTF-8";
	
	public static final String ERRORCODE_EMESSAGE_UNAVAILABLE="errors.emessage.unavailable";
	
	public static final String EMESSAGE_NEW_URL="EMESSAGE_NEW_URL";
	
	public static final String RTQ_SUBSCRIBE_INFO="RTQSubscribeInfo";

	public static final String ERRORCODE_LOTSZIE_NOT_MATCH = "LotsizeNotMatch";
	
	public static final String BUY_SIDE = "B";

	public static final String ERRORCODE_FUND_LACKING = "FundLacking";

	public static final String ERRORCODE_AON_INVALID_QTY = "AoNInvalidQty";	

	public static final String ISAPPLICATION = "isApplication";
	
	public final static String PSRTQPRODUCT = "PSRTQPRODUCT";
	
	public static final String AAS_URL ="AAS_URL";

	public static final String EXCEL_TYPE = "application/vnd.ms-excel";
	
	//add  by Arthur Chen on 20110421 for eipo
	public static final String EIPO_SUCCESS = "success";
}
