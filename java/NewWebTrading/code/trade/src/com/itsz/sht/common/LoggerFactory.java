...
/**
 * $Id: LoggerFactory.java,v 1.1 2010/11/09 03:57:25 kyzou Exp $
 * @Project:portal.head
 * @File:ITSZServiceImpl.java
 * @Description:
...
public class LoggerFactory {
    ...
    public void info(long beginTime , String model){
        ...
        getInstance().commonInfo.info(sf.format(calendar.getTime())+ " "+Thread.currentThread().getName()+" mcs call:"+ model +" " + (System.currentTimeMillis() - beginTime));
    }
