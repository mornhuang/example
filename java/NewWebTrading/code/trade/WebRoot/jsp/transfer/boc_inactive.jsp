...
<br>
	<table align=center border=0>
			...
			<tr>
				<td colspan=3><p><font class="odesc1"><html:img bundle="STT" srcKey="image.boc_transfer.heading"/></font></p></td>
			</tr>
    ...
    <table border="0" cellpadding="5" cellspacing="0" width=400>
        <tr align=center>
            <td colspan=3>
            <font class="odesc1"><BR><bean:message bundle="STT" key="errors.bocTransfer.unavailable"/><BR><BR><input type=button value="<bean:message bundle="STT" key="label.ppsTransferForm.close1"/>" onclick="CloseWindows()"><BR><BR></font>
            </td>
        </tr>			
    </table>
