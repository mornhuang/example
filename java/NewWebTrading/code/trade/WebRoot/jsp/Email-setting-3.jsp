    ...
    <div class="page-content">
        <div class="form-table-center ui-corner-all">
            ...
            <table>
                <tr>
                    <td class="message">
                        <bean:message key="label.email.content.row14"/>
                    </td>
                </tr>
                <tr>
                    <td>
                        <input type="button" class="short-button" value="<bean:message key="label.email.button3"/>" onclick="javascript:location.href='../webGetUserNotificationEmail.do'" />
                    </td>
                </tr>
            </table>
        </div>
