    ...
    <div class="page-content">
        <div class="form-table-center ui-corner-all">
            ...
            <table>
                <tr>
                    <td class="message">
                   <bean:message key="label.deposit.message2"/>
                    </td>
                </tr>
                <tr>
                    <td>
                        <input type="button" class="short-button" value="<bean:message key="button.common.back"/>" onclick="javascript:location.href='${pageContext.request.contextPath}/jsp/CheckFundDeposit.jsp'" />
                    </td>
                </tr>
            </table>
        </div>
