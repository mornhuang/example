	...
	for(var i = 0; i < tds.length; i++) {
		...
		if (dateArray[i]){
			tds[i].onclick = function () {
				...
				}if(calendar.dateControl.value>s){
					alert("不能选择未来时间");
...
document.write('<div id="__calendarPanel" style="position:absolute;visibility:hidden;z-index:9999;background-color:#FFFFFF;border:1px solid #666666;width:200px;height:216px;">');
document.write('<iframe name="__calendarIframe" id="__calendarIframe" width="100%" height="100%" scrolling="no" frameborder="0" style="margin:0px;"><\/iframe>');
