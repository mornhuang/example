...
INSERT INTO item ( item_name , item_remark , item_desc, kind_id, addtime , endtime, init_price,  max_price,  owner_id,  winer_id,  state_id)
	VALUES ( '主板', '老式主板', '老主板，还可以用', 1, '2009-02-06', CURDATE()+92, 230, 250, 1,  null,  1);

INSERT INTO item ( item_name , item_remark , item_desc, kind_id, addtime , endtime, init_price,  max_price,  owner_id,  winer_id,  state_id)
	VALUES ( '显卡', '老式显卡', '老显卡，还可以用', 1, '2009-10-10', CURDATE()-2, 210, 210, 2,  null,  3);

INSERT INTO item ( item_name , item_remark , item_desc, kind_id, addtime , endtime, init_price,  max_price,  owner_id,  winer_id,  state_id)
	VALUES ( '老房子', '老式房子', '40年的老房子', 2, '2009-12-12', CURDATE()-5, 21000, 25000, 2,  1,  2);
