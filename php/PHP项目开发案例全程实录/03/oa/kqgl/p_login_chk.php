...
if(($r_id == "14") or ($r_id == "16")){
	...
	$l_sql = "insert into tb_register (r_date,r_time,r_type,r_state,r_remark,r_id,p_id) values('".date("Y-m-d")."','".date("H:i:s")."',".$_POST[u_type].",'','".$_POST[r_remark]."',".$_POST[r_id].",".$_SESSION[id].")";
